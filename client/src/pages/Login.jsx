...
const Login = () => {
    ...
    return (
        ...
        >
            ...
            <h1 className='font-extralight text-sm mt-1'>Not a member? <Link to='/register' className='underline decoration-blue-500 underline-offset-8 hover:text-blue-500 hover:decoration-blue-900'>Sign Up</Link></h1>
